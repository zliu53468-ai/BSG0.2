...
    banker = np.mean([sgd_pred_prob[0], xgb_pred_prob[0], lgb_pred_prob[0], hmm_prob if hmm_pred == "莊" else 1-hmm_prob])



    player = np.mean([sgd_pred_prob[1], xgb_pred_prob[1], lgb_pred_prob[1], hmm_prob if hmm_pred == "閒" else 1-hmm_prob])
